...
public class ForceObject<T> {
  ...
  public ForceObject(T element, double x, double y, double z) {
    this(element, Point.of(x, y, z), 1);
  }

  public ForceObject(T element, double x, double y, double z, double mass) {
    this.element = element;
    p = Point.of(x, y, z);
    this.mass = mass;
  }
  ...
  public ForceObject add(ForceObject<T> other) {
    ...
    Point p =
        Point.of(
            ...
            (this.p.z * this.mass + other.p.z * other.mass) / totalMass);
    ;
