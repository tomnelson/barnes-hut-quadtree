...
import com.tom.quadtree.Point;
import com.tom.quadtree.Rectangle;
import java.awt.*;
...
public class BarnesHutVisualizer extends JPanel {
  ...
  public BarnesHutVisualizer() {
    ...
    tree = BarnesHutQuadTree.builder().withBounds(600, 600).build();
  ...
  private void clearNetwork() {
    elements.clear();
    stuffToDraw.clear();
    tree = BarnesHutQuadTree.builder().withBounds(getWidth(), getHeight()).build();
    tree.rebuild(elements);
    repaint();
  }
